...
const border6 = document.querySelector('.border6');

border6.addEventListener('mouseover', (e) => {
    const bound = border6.getBoundingClientRect();
    const top = bound.top;
    ...
    border6.appendChild(newelement);

    setTimeout(() => {
        border6.removeChild(newelement);
    }, 4000)
})
